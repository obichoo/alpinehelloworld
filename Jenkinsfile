                ...
                script {
                  sh '''
                   #!/bin/bash
                    ...
                    docker build --platform linux/amd64 -t ${ID_DOCKERHUB}/${IMAGE_NAME}:${IMAGE_TAG} .
                  '''
                }
             }
        }
      ...
      steps {
          script {
            sh '''
              ...
              heroku container:push -a $STAGING web --platform linux/amd64 --recursive 
              heroku container:release -a $STAGING web --platform linux/amd64 --recursive 
            '''
          }
        }
     }
